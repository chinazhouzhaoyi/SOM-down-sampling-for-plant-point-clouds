...
- [x] [Short-term] Publicize data pieces and configurations on visualized samples in figures of the paper.
- [x] [Short-term] Publicize code of the compared down-sampling methods (FPS, 3DEPS, VFS).
## Citation
